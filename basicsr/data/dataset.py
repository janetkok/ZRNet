...
class Conv3_fft(Aberration_CONV3):
    def __init__(self,img_size,timesteps=300,device='cpu',minFT=0,maxFT=115,precision=torch.float,zernike=[4,5,6,7,8,9],zRange=1.0):
        super().__init__(img_size,timesteps=timesteps,device=device,minFT=minFT,maxFT=maxFT,precision=precision,zernike=zernike,zRange=zRange)
